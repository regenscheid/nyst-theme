...
const themeExtensions = {
  gridTemplateColumns: {
    ...
    'article-lg':
      '[screen-start] 0.25rem [screen-inset-start page-start] 1rem [page-inset-start body-outset-start] 1fr [body-start gutter-left-start] 1rem [body-inset-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [middle-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [gutter-left-end] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [gutter-right-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [middle-end] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [body-inset-end] 1rem [body-end gutter-right-end] 3rem [body-outset-end] minmax(var(--myst-col-right-sidebar-min,5rem),var(--myst-col-right-sidebar-max,13rem)) [page-inset-end] 3rem [page-end] 1fr [screen-inset-end] 0.25rem [screen-end]',
    'article-xl':
      '[screen-start] 0.25rem [screen-inset-start] 1fr [page-start] 3rem [page-inset-start] minmax(var(--myst-col-left-margin-min,4rem),var(--myst-col-left-margin-max,9rem)) [body-outset-start] 3rem [body-start gutter-left-start] 1rem [body-inset-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [middle-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [gutter-left-end] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [gutter-right-start] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [middle-end] minmax(var(--myst-col-body-min,8ch),var(--myst-col-body-max,10ch)) [body-inset-end] 1rem [body-end gutter-right-end] 3rem [body-outset-end] minmax(var(--myst-col-right-sidebar-min,5rem),var(--myst-col-right-sidebar-max,13rem)) [page-inset-end] 3rem [page-end] 1fr [screen-inset-end] 0.25rem [screen-end]',
    'article-2xl':
