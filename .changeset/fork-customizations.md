...
- myst-to-react: Add normalizeWidth utility for container/table widths, add abbreviationList node type, apply explicit column widths and table widths, fix cite group rendering
...
- book theme: Add hasBibliographyNode check to avoid duplicate bibliographies, rename outline title to "In this publication"
